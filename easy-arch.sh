...
pacstrap /mnt base base-devel $kernel linux-headers $microcode linux-firmware btrfs-progs grub grub-btrfs efibootmgr snapper reflector base-devel snap-pac zram-generator
